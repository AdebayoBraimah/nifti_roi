...
if __name__ == "__main__":
    ...
    reqoptions.add_argument('-info', '--atlas-info',
                            type=str,
                            dest="info",
    ...
    # Run
    args.out_file = proc_vol(nii_file=args.nii,nii_atlas=args.atlas,atlas_info=args.info,out_file=args.out_file,thresh=args.thresh,dist=args.dist)
